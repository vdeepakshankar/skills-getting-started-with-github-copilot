...
activities = {
    "Chess Club": {
        "Art Club": {
            "description": "Explore various art techniques and create beautiful artwork",
            ...
            "Basketball": {
            "description": "Play basketball and develop court skills",
            "schedule": "Mondays and Wednesdays, 3:30 PM - 4:30 PM",
            "max_participants": 16,
            "participants": ["noah@mergington.edu", "ava@mergington.edu"]
            },
            "Soccer": {
            "description": "Play soccer and build team coordination",
